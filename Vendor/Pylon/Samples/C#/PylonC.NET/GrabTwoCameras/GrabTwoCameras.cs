        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                for (deviceIndex = 0; deviceIndex < NUM_DEVICES; ++deviceIndex)
                {
                    ...
                    Pylon.StreamGrabberGetPayloadSize( hDev[deviceIndex], hGrabber [deviceIndex], out payloadSize [deviceIndex] );
                ...
                for (deviceIndex = 0; deviceIndex < NUM_DEVICES; ++deviceIndex)
                {
                    ...
                    Pylon.StreamGrabberStartStreamingIfMandatory(hGrabber[deviceIndex]);
                ...
                for (deviceIndex = 0; deviceIndex < NUM_DEVICES; ++deviceIndex)
                {
                    ...
                    Pylon.StreamGrabberStopStreamingIfMandatory(hGrabber[deviceIndex]);
                }
                ...
                for (deviceIndex = 0; deviceIndex < NUM_DEVICES; ++deviceIndex)
                {
                    ...
                    Pylon.StreamGrabberFlushBuffersToOutput(hGrabber[deviceIndex]);
