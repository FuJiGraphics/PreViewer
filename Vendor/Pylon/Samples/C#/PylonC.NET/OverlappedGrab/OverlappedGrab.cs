    ...
    class OverlappedGrab
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Pylon.StreamGrabberGetPayloadSize( hDev, hGrabber, out payloadSize );
                ...
                Pylon.StreamGrabberStartStreamingIfMandatory(hGrabber);
                ...
                Pylon.StreamGrabberStopStreamingIfMandatory(hGrabber);

                /* ... We must issue a flush call to ensure that all pending buffers are put into the
                   stream grabber's output queue. */
                Pylon.StreamGrabberFlushBuffersToOutput(hGrabber);
